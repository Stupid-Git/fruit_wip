...
export default class Information extends React.Component {
  ...
  componentDidMount() {
    ...
    let s = ipcRenderer.sendSync('getServices', this.props.match.params.index);
  ...
  charUpdated(sender, serviceId, charId, value) {
  ...
  readChar(serviceId, charId) {
    ...
    //ipcRenderer.send('readChar', event.target.dataset.serviceid, event.target.dataset.charid);
    ipcRenderer.send('readChar', serviceId, charId);
  }

  render(){
    console.log('Information: Render this.props', this.props);
    console.log('Information: Render this.state', this.state);
    ...
    return (
      <DeviceView header='Information' index={this.props.match.params.index}>
        {deviceInfo}
